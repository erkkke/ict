...
namespace DrawingApp
{
    class Utils
    {
        static void Step(int x, int y, int w, int h, Bitmap bmp, Color originColor, Color fillColor, Queue<Point> q)
        {
            if (x >= 0 && y >= 0 && x < w && y < h)
            {
        ...
        public static Bitmap Fill(Bitmap bmp, Point originPoint, Color originColor, Color fillColor)
        {
